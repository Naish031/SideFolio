export const timeline = [
  {
    company: 'Xgrid.co',
    title: 'Junior Software Engineer | Full-Stack Project',
    date: '2025 (July–September)',
    description: 'Building internal tools for inventory and access management',
    responsibilities: [
      'Designed and developed a full-stack inventory management system using Next.js, React, Node.js, Express, and MongoDB',
      'Implemented role-based authentication and approval workflows where users require admin approval before accessing the system',
      'Built admin dashboards to manage users, inventory items, and view detailed check-in/check-out activity logs',
      'Integrated REST APIs with frontend interfaces to handle inventory updates, permissions, and real-time data display',
      'Focused on clean UI, maintainable architecture, and performance for internal business use cases',
    ],
  },
  {
